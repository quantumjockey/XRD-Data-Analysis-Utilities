package edu.hipsec.app.workspaces.singleimagecorrection.components;

import edu.hipsec.app.controls.filegroupselector.FileGroupSelector;
import edu.hipsec.app.controls.diffractionframeworkspace.DiffractionFrameWorkspace;
import edu.hipsec.app.filesystem.FileSysReader;
import edu.hipsec.app.workspaces.WorkspaceController;
